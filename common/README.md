...
[![Build
Status](https://travis-ci.org/etclabscore/go-ethereum.png?branch=master)](https://travis-ci.org/ethereum/go-ethereum)
...
`go get github.com/etclabscore/go-ethereum`.
