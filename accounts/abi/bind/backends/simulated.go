...
func NewSimulatedBackend(accounts ...core.GenesisAccount) *SimulatedBackend {
	...
	blockchain, _ := core.NewBlockChain(database, core.DefaultConfigMordor.ChainConfig, new(core.FakePow), new(event.TypeMux))
...
func (b *SimulatedBackend) Rollback() {
	blocks, _ := core.GenerateChain(core.DefaultConfigMordor.ChainConfig, b.blockchain.CurrentBlock(), b.database, 1, func(int, *core.BlockGen) {})
...
func (b *SimulatedBackend) ContractCall(contract common.Address, data []byte, pending bool) ([]byte, error) {
	...
	vmenv := core.NewEnv(statedb, core.DefaultConfigMordor.ChainConfig, b.blockchain, msg, block.Header())
...
func (b *SimulatedBackend) SendTransaction(tx *types.Transaction) error {
	blocks, _ := core.GenerateChain(core.DefaultConfigMordor.ChainConfig, b.blockchain.CurrentBlock(), b.database, 1, func(number int, block *core.BlockGen) {
